...
class TEXT:
    DOWNLOAD_START = f"𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠... {SUNGLASSES}"
    UPLOAD_START = f"𝐔𝐩𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠... {SUNGLASSES}"
    UPLOAD_SUCESS = f"Thanks for using [me](https://t.me/rocky_rename_bot)"
